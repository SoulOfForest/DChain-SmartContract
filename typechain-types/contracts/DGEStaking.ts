...
export interface DGEStakingInterface extends utils.Interface {
  functions: {
    ...
    "setPoolAPR(uint256,uint64)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setPoolAPR", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setPoolPeriod",
    data: BytesLike
  ): Result;
...
export interface DGEStaking extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DGEStakingInterface;
