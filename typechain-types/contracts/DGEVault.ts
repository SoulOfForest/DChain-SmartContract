...
export declare namespace DGEVault {
...
export interface DGEVaultInterface extends utils.Interface {
  functions: {
...
export interface DGEVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DGEVaultInterface;
  ...
  functions: {
    ...
    getVestingScheduleByAddressAndIndex(
      ...
      index: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[DGEVault.VestingScheduleStructOutput]>;
