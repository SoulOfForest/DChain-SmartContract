...
export interface DGWVaultInterface extends utils.Interface {
  functions: {
    ...
    "allowToStakeUsingLockedBalance()": FunctionFragment;
    ...
    "setAllowToStakeUsingLockedBalance(bool)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "renounceRole"
      | "revokeRole"
      | "setAllowToStakeUsingLockedBalance"
      | "setCloseTime"
  ...
  encodeFunctionData(
    functionFragment: "allowToStakeUsingLockedBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setAllowToStakeUsingLockedBalance",
...
export interface DGWVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DGWVaultInterface;
  ...
  functions: {
    ...
    setAllowToStakeUsingLockedBalance(
      _allowToStakeUsingLockedBalance: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  allowToStakeUsingLockedBalance(overrides?: CallOverrides): Promise<boolean>;
