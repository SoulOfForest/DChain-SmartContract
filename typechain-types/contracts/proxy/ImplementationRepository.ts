...
export interface ImplementationRepositoryInterface extends utils.Interface {
  functions: {
...
export interface ImplementationRepository extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ImplementationRepositoryInterface;
